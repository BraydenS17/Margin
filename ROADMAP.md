...
### Tests
- 17 unit tests (Swift Testing): model relationships, cascade deletes, `PageBackground`/`BlockType` raw-value round-tripping and fallback, table JSON round-tripping, template-to-block instantiation.
...
- **M5 — Organization & polish**: reorder/move across notebooks, search, thumbnails, export/share, onboarding.
